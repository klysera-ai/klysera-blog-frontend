...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white dark:bg-black" style={{ height: '100px' }}>
            ...
            {mounted && (
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={`p-2 border border-gray-300 hover:bg-gray-100 dark:hover:bg-black transition-colors ${
            ...
            <div className="flex flex-col items-center p-6 space-y-8">
              ...
              {mounted && (
                <div className="flex items-center gap-2">
                  ...
                  <button
                    onClick={() => theme === 'dark' && toggleTheme()}
                    className={`flex items-center gap-2 px-4 py-3 border border-gray-300 hover:bg-gray-100 dark:hover:bg-black transition-colors ${
                      theme === 'light' ? 'bg-gray-100' : ''
                    }`}
                    style={{ borderColor: theme === 'dark' ? '#FFFFFF63' : undefined }}
                    aria-label="Switch to light mode"
                  >
                    ...
                    <span className="text-sm" style={{ color: theme === 'dark' ? '#FFFFFF63' : undefined }}>Light</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-sm" style={{ color: theme === 'dark' ? '#FFFFFF63' : undefined }}>Dark</span>
                  </button>
                </div>
              )}
            </div>
