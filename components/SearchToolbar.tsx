          ...
          <div className="flex md:hidden flex-col gap-4">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="relative flex items-center border border-gray-300 dark:border-gray-700 rounded-none p-1 flex-1">
                ...
                >
                  <svg width="22.5" height="22.5" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" className={viewMode === 'grid' ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400'}>
                ...
                >
                  <svg width="16.2" height="15.3" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg" className={viewMode === 'list' ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400'}>
