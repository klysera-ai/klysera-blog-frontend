          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            {mounted && (
              <div 
                ...
                style={{ borderRadius: '2px', padding: '2px', height: '24px' }}
              >
                ...
                >
                  <svg width="15" height="12.6" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                  <svg width="12.6" height="12.6" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" className="dark:invert">
